...
const MyOrder = () => {
  ...
  return (
    <div className="min-h-screen p-4  bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900 bg-opacity-70">
      <h1 className="mb-4 text-3xl font-bold text-white">My Orders</h1>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-200 rounded-md shadow-md">
          <thead className="text-gray-600 bg-gray-200">
            <tr>
